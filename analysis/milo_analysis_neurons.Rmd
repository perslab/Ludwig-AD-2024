...
hippo.neurons$cell.type <- hippo.neurons$cell.type2
...
### Perform milo analysis for hippocampal neurons (veh-LPS vs. veh-PBS) ###
```{r}
# Subset Seurat object
groups <- c("Veh-PBS", "Veh-LPS")
hippo.veh <- subset(hippo.neurons, drug %in% groups)
...
# Save milo object
```{r}
# saveRDS(hippo.veh.milo, file = "/projects/mludwig/hippo_GLP1/output/milo_objs/hippo_neurons_veh_milo_obj.rds")
```



### Perform milo analysis for hippocampal neurons (sema-LPS vs. veh-LPS) ###
```{r}
# Subset Seurat object
groups <- c("Veh-LPS", "Sema-LPS")
hippo.LPS <- subset(hippo.neurons, drug %in% groups)
...
# Save milo object
```{r}
# saveRDS(hippo.LPS.milo, file = "/projects/mludwig/hippo_GLP1/output/milo_objs/hippo_neurons_LPS_milo_obj.rds")
```




### Perform milo analysis for DVC neurons (veh-LPS vs. veh-PBS) ###
```{r}
# Subset Seurat object
groups <- c("Veh-PBS", "Veh-LPS")
DVC.veh <- subset(DVC.neurons, drug %in% groups)
...
# Save milo object
```{r}
# saveRDS(DVC.veh.milo, file = "/projects/mludwig/hippo_GLP1/output/milo_objs/DVC_neurons_veh_milo_obj.rds")
```



### Perform milo analysis for DVC neurons (sema-LPS vs. veh-LPS) ###
```{r}
# Subset Seurat object 
groups <- c("Veh-LPS", "Sema-LPS")
DVC.LPS <- subset(DVC.neurons, drug %in% groups)
...
# Save milo object
```{r}
# saveRDS(DVC.LPS.milo, file = "/projects/mludwig/hippo_GLP1/output/milo_objs/DVC_neurons_LPS_milo_obj.rds")
```
